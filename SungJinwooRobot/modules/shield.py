...
# from SungJinwooRobot.db.mongo_helpers.nsfw_guard import add_chat, get_all_nsfw_chats, is_chat_in_db, rm_chat
from SungJinwooRobot.function.telethonbasics import is_admin
...
__help__ = """
<b> Group Guardian: </b> 
Senku can protect your group from NSFW senders, Slag word users and also can force members to use English
